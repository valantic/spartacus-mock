        ...
        baseSites: [
            {
                ...
                urlPatterns: ['(?i)^https?://[^/]+(/[^?]*)?\\?(.*\\&)?(site=electronics-spa)(|\\&.*)$', '(?i)^https?://electronics-spa\\.[^/]+(|/.*|\\?.*)$', '(?i)^https?://api\\.hybrisdev\\.com(:[\\d]+)?/rest/.*$', '(?i)^https?://localhost(:[\\d]+)?/rest/.*$', '(?i)^https?://localhost(:[\\d]+)?(|/.*|\\?.*)$', '(?i)^https?://[^/]+/electronics-spa(|/.|\\?.)$', '(?i)^https?://[^/]+/electronics-spa(|/.*|\\?.*)$']
            }
        ]
    };
}
